  ...
  return (
    <>
      ...
      >
        ...
        <p className="max-w-3xl mx-auto mt-5 px-4 text-center sm:px-[5%]">
          As a passionate BCA student and aspiring MERN Stack Developer,
          I continuously learn and apply modern technologies to build
          real-world solutions. Then creating responsive, scalable,
          and user-friendly full-stack web applications using modern
